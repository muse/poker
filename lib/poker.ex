defmodule Poker do
  ...
  def play(:predefined) do
    [
      ["TH", "JH", "QH", "KH", "AH"], # Straight flush # A
      ["2H", "3H", "4H", "5H", "AH"], # Straight flush # 5
      ["2H", "2C", "2D", "2S", "AH"], # FOAC           # 2
      ["2H", "3H", "2D", "3C", "3D"], # Full house     # 3
      ["2H", "2H", "2D", "3C", "3D"], # Full house     # 2
      ["KC", "TC", "7C", "6C", "4C"], # Flush          # K
      ["QC", "TC", "7C", "6C", "3C"], # Flush          # Q
      ["9H", "TH", "QH", "KH", "JC"], # Straight       # K
      ["AH", "2D", "3C", "4C", "5D"], # Straight       # 5
      ["2H", "2D", "2C", "KC", "QD"], # TOAC           # 2
      ["2H", "7H", "2D", "3C", "3D"], # Two pair       # 3
      ["2H", "6H", "2D", "3C", "3D"], # Two pair       # 3
      ["4H", "4S", "TS", "3D", "KS"], # One pair       # 4
      ["KH", "4S", "TS", "2D", "KS"], # One pair       # K
